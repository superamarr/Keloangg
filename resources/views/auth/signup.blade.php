...
<body>
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <h1 class="auth-title">Daftar ke Keloang</h1>
                <p class="auth-subtitle">Mulai kelola keuanganmu hari ini</p>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-wrapper">
                        ...
                        <input 
                            ...
                            autocomplete="new-password"
                        >
                        <button type="button" class="password-toggle-btn" id="passwordConfirmationToggle" aria-label="Toggle password visibility">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
    ...
    <script>
        ...
        signupForm.addEventListener('submit', function(e) {
            ...
            if (csrfToken) {
                const tokenInput = signupForm.querySelector('input[name="_token"]');
                if (tokenInput) {
        ...
        togglePassword(passwordConfirmationInput, passwordConfirmationToggle);

        // Password confirmation validation
        function validatePasswordMatch() {
            if (passwordConfirmationInput.value && passwordInput.value !== passwordConfirmationInput.value) {
                passwordConfirmationInput.setCustomValidity('Password tidak sesuai');
            } else {
        ...
        setInterval(function() {
            ...
            .then(response => {
                ...
                if (newToken) {
                    ...
                    const formToken = signupForm.querySelector('input[name="_token"]');
